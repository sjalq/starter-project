...
Vendored from [lamdera/auth](https://github.com/lamdera/auth) (MIT, see `LICENSE`) with an Auth0 OAuth method and a `picture` field on `UserInfo` added for this starter. The upstream README follows.
